            ...
            {showModal && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
                    <div className="relative w-[30vw] min-w-[320px] rounded-2xl bg-zinc-900 border border-zinc-800 text-white p-8 shadow-2xl">
                        ...
                        <h2 className="text-xl font-bold mb-6 text-green-400">Add New Document</h2>
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <textarea 
                                    className="bg-zinc-950 border border-zinc-800 rounded-xl p-3 focus:outline-none focus:border-green-400 resize-none h-24"
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <input 
                                    type="text"
                                    className="bg-zinc-950 border border-zinc-800 rounded-xl p-3 focus:outline-none focus:border-green-400"
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <select 
                                    className="bg-zinc-950 border border-zinc-800 rounded-xl p-3 focus:outline-none focus:border-green-400 cursor-pointer"
                                    value={tagColor}
                            ...
                            <button 
                                onClick={handleSave}
                                className="mt-4 rounded-xl bg-green-400 hover:bg-green-500 text-zinc-950 cursor-pointer py-3 font-bold transition-all shadow-md shadow-green-500/20 active:scale-95"
                            >
                                Save Document
                            </button>
                        </div>
