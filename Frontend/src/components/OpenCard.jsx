...
export default function OpenCard({ showModal, setShowModal, title }) {
    ...
    return (
        <>
            {showModal && <div className=" px-10 pt-24 pb-12 overflow-y-scroll h-[89vh] bg-zinc-950 w-[40vw] text-white z-100 rounded-xl absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%]">
                ...
                <button className="absolute right-6 bottom-6 rounded-xl bg-green-400 hover:bg-green-600 cursor-pointer py-2 px-5 font-bold ">Save</button>
            </div>}
